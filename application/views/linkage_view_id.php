		...
		<div class = "col-md-12" >
			...
			<div class="row">
				...
				<?php
    				...
    				<?php
                                    echo form_open('index.php/linkages/linkages_view');
                                    
                                    echo form_label($linkage_id);
                                    echo '<br /><br />';
                                    echo form_label($company_name);
                                    echo '<br /><br />';
                                    echo form_label($company_tel_no);
                                    echo '<br /><br />';
                                    echo form_label($address_no);
                                    echo '<br /><br />';
                                    echo form_label($street_address);
                                    echo '<br /><br />';
                                    echo form_label($city_address);
                                    echo '<br /><br />';
                                    echo form_label($region);
                                    echo '<br /><br />';
                                    echo form_label($zip);
                                    echo '<br /><br />';
                                    echo form_label($contact_fname);
                                    echo '<br /><br />';
                                    echo form_label($contact_mi);
                                    echo '<br /><br />';
                                    echo form_label($contact_lname);
                                    echo '<br /><br />';
                                    echo form_label($contact_position);
                                    echo '<br /><br />';
                                    echo form_label($contact_email);
                                    echo '<br /><br />';
                                    echo form_label($contact_number);
                                    echo '<br /><br />';
                                    echo form_label($sy_start);
                                    echo '<br /><br />';
                                    echo form_label($sy_end);
                                    echo '<br /><br />';
                                    echo form_label($program_supported);
                                    echo '<br /><br />';
                                    echo form_label($brief_desc);
                                    echo '<br /><br />';
                                    echo form_label($slo);
                                    echo '<br /><br />';
                                    echo form_label($grad_employability);
                                    echo '<br /><br />';
                                    echo form_submit('submit', 'Return To Linkages View');
                                    echo '<br /><br />';
                                    echo form_close();                          
                    ?>
              <?php endforeach; ?>
